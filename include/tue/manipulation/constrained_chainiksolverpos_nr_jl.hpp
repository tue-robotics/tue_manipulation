...
#ifndef CONSTRAINEDKDLCHAINIKSOLVERPOS_NR_JL_HPP
#define CONSTRAINEDKDLCHAINIKSOLVERPOS_NR_JL_HPP
...
namespace KDL {
     ...
     */
    class ConstrainedChainIkSolverPos_NR_JL : public ChainIkSolverPos
    {
    public:
        /**
