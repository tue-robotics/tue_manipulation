...
public:
  ...
  RobotArm() 
  {
    ...
    traj_client_ = new TrajClient("l_joint_trajectory_action", true);
  ...
  */
  control_msgs::FollowJointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.points[ind].positions[1] = -2.0;
    goal.trajectory.points[ind].positions[2] = 0.0;
    goal.trajectory.points[ind].positions[3] = 1.5703;
    goal.trajectory.points[ind].positions[4] = 0.0;
    goal.trajectory.points[ind].positions[5] = -1.5703;
    ...
    goal.trajectory.points[ind].positions.resize(7);
    goal.trajectory.points[ind].positions[0] = 0.0;
    goal.trajectory.points[ind].positions[1] = -1.5708;
    goal.trajectory.points[ind].positions[2] = 0.0;
    goal.trajectory.points[ind].positions[3] = 0.71;
    goal.trajectory.points[ind].positions[4] = 0.0;
    goal.trajectory.points[ind].positions[5] = -1.5703;
    goal.trajectory.points[ind].positions[6] = 0.0;
