...
int main(int argc, char **argv){
  ...
  ROS_INFO("Test for move left arm server");
  ...
  names[0] = "shoulder_yaw_joint_left";
  names[1] = "shoulder_pitch_joint_left";
  names[2] = "shoulder_roll_joint_left";
  names[3] = "elbow_pitch_joint_left";
  names[4] = "elbow_roll_joint_left";
  names[5] = "wrist_pitch_joint_left";
  names[6] = "wrist_yaw_joint_left";
  ...
  goalB.motion_plan_request.goal_constraints.joint_constraints[0].position = -0.3;
  goalB.motion_plan_request.goal_constraints.joint_constraints[1].position = -1.2;
  goalB.motion_plan_request.goal_constraints.joint_constraints[2].position = -0.0;
  goalB.motion_plan_request.goal_constraints.joint_constraints[3].position =  0.05; //1.57
  goalB.motion_plan_request.goal_constraints.joint_constraints[4].position = -0.0;
  goalB.motion_plan_request.goal_constraints.joint_constraints[5].position = -1.57;
